...
console.log(`The first character of ${message} is ${message.indexOf("If")}`);

// Log the last character of message using length like `The last character of [message] is [character]`
console.log(`The first character of ${message} is ${message.lastindexOf("")}`);
...
const newMessage = message.replace("are","can't");
...
const Message = message.replace("still"," ");
console.log(Message);
...
var message1 = message.replace("thinking","decide ");
